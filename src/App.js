      ...
      <div className='wrapper'>
        <div className='screen'>
          {input !== "" || input === "0" ? (
            ...
            <div className='btn red' onClick={reset}>AC</div>
            <div className='btn blue' onClick={percent}>%</div>
            <div className='btn blue' onClick={minusPlus}>+/-</div>
            ...
            <div className='btn green' onClick={equals}>=</div>
      </div>
